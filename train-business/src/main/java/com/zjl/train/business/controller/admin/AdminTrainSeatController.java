...
public class AdminTrainSeatController {
    ...
    @PostMapping("/save")
    public CommonResp<Object> saveSeat(@Valid @RequestBody TrainSeatSaveReq req) {
        trainSeatService.save(req);
        return new CommonResp<>();
    }

    @GetMapping("/query-list")
    public CommonResp<PageResp<TrainSeatQueryResponse>> querySeatList(@Valid TrainSeatQueryReq req) {
